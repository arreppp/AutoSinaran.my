...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24, paddingBottom: 16, borderBottomWidth: 2, borderBottomColor: '#00A19C' },
  logoBlock: {},
  logoText: { fontSize: 22, fontFamily: 'Helvetica-Bold', color: '#0A1515' },
  logoSub: { fontSize: 8, color: '#00A19C', letterSpacing: 2, marginTop: 2 },
  address: { fontSize: 8, color: '#666', textAlign: 'right', lineHeight: 1.5 },
  receiptTitle: { backgroundColor: '#0A1515', padding: '8 16', marginBottom: 20, borderRadius: 4 },
  receiptTitleText: { color: '#FFFFFF', fontFamily: 'Helvetica-Bold', fontSize: 14, letterSpacing: 1 },
  receiptId: { color: '#00A19C', fontSize: 10, marginTop: 2 },
  section: { marginBottom: 16 },
  sectionTitle: { fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#00A19C', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 },
  ...
  bullet: { width: 4, height: 4, borderRadius: 2, backgroundColor: '#00A19C', marginRight: 6 },
  serviceText: { fontSize: 9, color: '#444' },
  totalBox: { backgroundColor: '#0A1515', padding: '10 16', borderRadius: 4, marginTop: 12, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  totalLabel: { color: '#FFFFFF', fontSize: 10, fontFamily: 'Helvetica-Bold' },
  totalAmount: { color: '#00A19C', fontSize: 16, fontFamily: 'Helvetica-Bold' },
  ...
  footerBrand: { fontSize: 8, color: '#00A19C', fontFamily: 'Helvetica-Bold', textAlign: 'center' },
})
